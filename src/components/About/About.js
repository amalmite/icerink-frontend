    ...
    return (
        <>
            {isLoading ? (
                ...
                <div>
                    <div style={{ width: '100%' }}>
                        <img src={image4} style={{ width: '100%', objectFit: 'cover',maxHeight:'50vh'}} alt="Skate ground" loading='lazy' />
                    </div>
                    ...
                    <div style={{ backgroundColor: '#E5E5E5', padding: '4%' }}>
                        <Row className="justify-content-center text-center">
                            <Row className="align-items-center p-5 ">
                                ...
                                <Col xs="auto">
                                    <p className='fs-2 fw-light' style={{ margin: '0 4px' }}>EVENTS</p >
                                </Col>
                                <Col>
                                    <hr/>
                                </Col>
                            ...
                            {imageUrls.map((imageUrl, index) => (
                                <Col key={imageUrl} xs={12} sm={6} md={4} lg={3}>
                                    <Card style={{ maxWidth: '400px', maxHeight: '500px', margin: '2%' }}>
                                        <img variant="top" src={imageUrl} style={{ height: '250px', objectFit: 'cover' }} alt={`Event ${index + 1}`} />
                                        <Card.Body>
